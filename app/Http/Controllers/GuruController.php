...
class GuruController extends Controller
{
     ...
     */
    public function index() //menampilkan data guru
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(Request $request) //masukkin data ke database
    {
    ...
    public function destroy(Guru $guru)
    {
        ...
        if($mengajar) {
            return back()->with('error', "$guru->nama_guru masih digunkan di menu mengajar");
        }
